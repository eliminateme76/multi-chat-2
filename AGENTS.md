...
- Completed redacted runtime traces are retained in PostgreSQL for the monitor; live runs remain in memory/SSE. Never persist raw prompts, secrets, memory text or generated draft content in monitor traces.
