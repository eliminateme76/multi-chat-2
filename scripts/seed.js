...
try {
  ...
  await pool.query(`INSERT INTO projects (id,title,location,mood,scene_time,description,rules,scene_number,turn_number,director_note) VALUES ($1,$2,$3,$4,$5,$6,$7,1,0,$8)`, [projectId, '별빛 마도학원', '중앙 도서관, 금서 보관실 앞', '긴장 · 미스터리', '폭풍우 치는 밤', '늦은 밤. 폭풍우가 창을 두드리고, 오래된 마법서가 희미하게 빛난다.', '고위 공격 마법은 교내에서 금지된다, 마법 계약은 쉽게 파기할 수 없다', '세라의 비밀을 둘러싼 긴장을 유지하세요. 루카에게는 아직 확실한 증거가 없습니다.']);
